...
<form method="POST" oninput="TotalSoft_Portfolio_Out()">
	...
	<div class="Total_Soft_Portfolio_AMD">
		...
		<div class="Total_Soft_Portfolio_AMD3">
			...
			<button type="submit" class="Total_Soft_Portfolio_Update_Option Total_Soft_Portfolio_AMD2_But" name="Total_Soft_Portfolio_Update_Option">
				Update
			</button>
			...
			<input type="text" style="display:none" id="Total_Soft_GP_Theme_Prev" value="<?php echo home_url(); ?>?ts_portfolio_preview_theme=true">
		</div>
	</div>
		...
		<?php for($i=0;$i<count($TotalSoft_PG_O);$i++){ ?>
			<tr id="Total_Soft_PortfolioTMOTable_tr_<?php echo $TotalSoft_PG_O[$i]->id;?>">
				...
				<td>
					...
					<?php }else{ ?>
						<a href="<?php echo home_url(); ?>?ts_portfolio_preview_theme=<?php echo $TotalSoft_PG_O[$i]->id;?>" class="Total_Soft_Portfolio_AMD2_But_LP" target="_blank">
	...
	<div class="TS_Port_Option_Div_Set TS_Port_Option_Divv" id="Total_Soft_Port_AMSet_Table" style="margin-top: 15px;">
		<div class="TS_Port_Option_Divv1">
			<div class="TS_Port_Option_Div1">
				<div class="TS_Port_Option_Name">Setting Title <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Write your Portfolio’s name."></i></div>
		...
		<div class="TS_Port_Option_Divv2">
			<div class="TS_Port_Option_Div1">
				<div class="TS_Port_Option_Name">Portfolio Type <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the one from this options."></i></div>
				<div class="TS_Port_Option_Field">
	...
	<div class="Total_Soft_Port_AMSetDiv" id="Total_Soft_Port_AMSetDiv_1">
		<div class="Total_Soft_Port_AMSetDiv_Buttons">
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_1_GO" onclick="TS_Port_TM_But('1', 'GO')">General Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_1_IO" onclick="TS_Port_TM_But('1', 'IO')">Image Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_1_NO" onclick="TS_Port_TM_But('1', 'NO')">Navigation Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_1_AO" onclick="TS_Port_TM_But('1', 'AO')">Arrow Option</div>
		</div>
		<div class="Total_Soft_Port_AMSetDiv_Content">
			<div class="TS_Port_Option_Div" id="Total_Soft_Port_AMSetTable_1_GO">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Container Height <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the size of the main Portfolio Gallery, where placed your all photos."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Background Image <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the background image for the gallery, also your portfolio can be without a background image."></i></div>
					<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div" id="Total_Soft_Port_AMSetTable_1_IO">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Width <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="It allows you to specify the preferred width of the image and it is all responsive in portfolio."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Height <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="It allows you to specify the preffered height of the image and it is all responsive in portfolio."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Border Width <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the borders of individual images."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Border Style <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose the frame style for image."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Border Color <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the border color."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="TotalSoft_PG_TG_07" id="TotalSoft_PG_TG_07" class="Total_Soft_Port_Color" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Border Radius <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the border radius of the image."></i></div>
					<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div" id="Total_Soft_Port_AMSetTable_1_NO">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Size <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the size of navigation in the gallery of the portfolio."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Radius <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Install the radius borders for navigation."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the color for the general navigation."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="" id="TotalSoft_PG_TG_11" class="Total_Soft_Port_Color" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Current Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the color for current navigation at the main gallery."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="" id="TotalSoft_PG_TG_12" class="Total_Soft_Port_Color" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Hover Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose a moving navigation color."></i></div>
					<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div" id="Total_Soft_Port_AMSetTable_1_AO">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Choose Icon <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="You can choose the right and left icons, which will change the photos in gallery."></i></div>
					<div class="TS_Port_Option_Field">
						<select class="Total_Soft_Select" name="" id="TotalSoft_PG_TG_14" style="font-family: 'FontAwesome', Arial;">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose the icon color, which is designed to change the images."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="" id="TotalSoft_PG_TG_15" class="Total_Soft_Port_Color" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Size <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select that size, which would be more relevant for portfolio. It is responsive too."></i></div>
					<div class="TS_Port_Option_Field">
	...
	<div class="Total_Soft_Port_AMSetDiv" id="Total_Soft_Port_AMSetDiv_2">
		<div class="Total_Soft_Port_AMSetDiv_Buttons">
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_2_GO" onclick="TS_Port_TM_But('2', 'GO')">General Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_2_NO" onclick="TS_Port_TM_But('2', 'NO')">Navigation Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_2_IT" onclick="TS_Port_TM_But('2', 'IT')">Image & Title</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_2_PO" onclick="TS_Port_TM_But('2', 'PO')">Popup Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_2_TO" onclick="TS_Port_TM_But('2', 'TO')">Thumbnails Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_2_IO" onclick="TS_Port_TM_But('2', 'IO')">Icon Option</div>
		</div>
		<div class="Total_Soft_Port_AMSetDiv_Content">
			<div class="TS_Port_Option_Div" id="Total_Soft_Port_AMSetTable_2_GO">
				<div class="TS_Port_Option_Div1 Total_Soft_Titles">General Options</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Text to Show All <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Write name that will be appear in the line of menu bar. Here will be included all albums."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="TotalSoft_PG_EG_01" id="TotalSoft_PG_EG_01" class="Total_Soft_Select" placeholder=" * Required" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Show Menu <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the menu should appear or not by Yes or No via buttons."></i></div>
					<div class="TS_Port_Option_Field">
						<div class="switch">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Filter Effect <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the Effect , which should be applied by images to changing albums or by clicking on the images to see the description."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Hover Effect <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select there is a need to Hover Effect or not."></i></div>
					<div class="TS_Port_Option_Field">
						<div class="switch">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Hover Delay <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="The next step is to create a delay function when you hold the mouse on the picture."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Hover Inverse <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Mark gallery hover effect appear on the reverse side or not."></i></div>
					<div class="TS_Port_Option_Field">
						<div class="switch">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Expanding Speed <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the speed when clicking on the picture will open the lightbox."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Expanding Height <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the height of Lightbox."></i></div>
					<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div TS_Port_Option_Divv" id="Total_Soft_Port_AMSetTable_2_NO">
				<div class="TS_Port_Option_Divv1">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Main Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Identify gallery portfolio’s main menu background color."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_EG_09" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Current Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the menu background color for gallery navigation, which all the categories displayed in the main menu."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_EG_10" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Current Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the menu text color for gallery."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_EG_11" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the background color for navigation menu."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_EG_12" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose the menu font color. When Portfolio separated with options."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_EG_13" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Font Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine your preferred font size for menu."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Font Family <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="For the menu text choose the font family."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Hover Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the background color for hover."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_EG_16" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Hover Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the menu font color when the portfolio is separated by categories."></i></div>
						<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Divv2">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Width <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Show dividing line. Select the width which divides the menu title."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Style <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select dividing line style between the menu and the title."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select dividing line color between the menu and the title."></i></div>
						<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div TS_Port_Option_Divv" id="Total_Soft_Port_AMSetTable_2_IT">
				<div class="TS_Port_Option_Divv1">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the name of the color image for the gallery portfolio."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_EG_26" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Font Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Define the font size for the title."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Font Family <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Define the font family for the title."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Width <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the width for line after title."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Style <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the style for line after title."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the color for line after title."></i></div>
						<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Divv2">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Width <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="It allows you to specify the preferred width of the image for gallery."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Height <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="It allows you to specify your preferred height of the image."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Border Radius <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the radius border for image."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Box Shadow Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the box shadow color for image."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_EG_24" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Hover Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Specify preferred hover background color for the image in the gallery."></i></div>
						<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div TS_Port_Option_Divv" id="Total_Soft_Port_AMSetTable_2_PO">
				<div class="TS_Port_Option_Divv1">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Clicking on the image opens a popup, select your preferable background color for popup."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Clicking on the image opens a popup, select your preferable title color for popup."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_EG_33" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Font Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Clicking on the image opens a popup, choose your preferable font size for popup."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Font Family <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select your preferable Font Family for popup title, Gallery Portfolio has a font base."></i></div>
						<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Divv2">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the background color, which is designed for Link button."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_EG_36" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the color of the button, which you will see in Popup, under the description."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_EG_37" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Font Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the font size for Gallery Popup."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Font Family <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select that font family, which will make your portfolio more beautiful."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Border Width <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the link border width."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Border Style <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the link border style."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Border Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the link border color, which is in the Lightbox portfolio."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_EG_42" class="Total_Soft_Port_Color1" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Border Radius <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Install the border radius for Gallery link."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Hover Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select hover background color for link in the Gallery."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_EG_44" class="Total_Soft_Port_Color1" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Hover Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title=" Select hover color for link in the Gallery."></i></div>
						<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div TS_Port_Option_Divv" id="Total_Soft_Port_AMSetTable_2_TO">
				<div class="TS_Port_Option_Divv1">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Specify the preferred background color of the thumbnails in the gallery."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_EG_49" class="Total_Soft_Port_Color1" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Box Shadow Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the box shadow color for Thumbnails."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_EG_50" class="Total_Soft_Port_Color1" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Image Height <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Specify the preferred image height for thambnail in gallery."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Border Width <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Specify the preferred border width for thumbnail."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Border Style <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose a style to apply to the thumbnail border in gallery."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Border Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the preferred color for the border."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_EG_54" class="Total_Soft_Port_Color1" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Border Radius <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the border radius in your gallery miniature."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Current Border Color <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the current color of the border."></i></div>
						<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Divv2">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Width <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the width of the line in Lightbox, between the title and pictures."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Style <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select a line style in Lightbox, between the title and pictures."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the line color."></i></div>
						<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div TS_Port_Option_Divv" id="Total_Soft_Port_AMSetTable_2_IO">
				<div class="TS_Port_Option_Divv1">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Icon Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="You can select icons from a variety of beautifully designed sets for the lightbox."></i></div>
						<div class="TS_Port_Option_Field">
							<select class="Total_Soft_Select" name="" id="TotalSoft_PG_EG_57" style="font-family: 'FontAwesome', Arial;">
								<option value='1'>  <?php echo '&#xf100' . '&nbsp; &nbsp; &nbsp;' . 'Angle Double';?>  </option>
								<option value='2'>  <?php echo '&#xf104' . '&nbsp; &nbsp; &nbsp;&nbsp;' . 'Angle';?>   </option>
								<option value='3'>  <?php echo '&#xf0a8' . '&nbsp; &nbsp;&nbsp;' . 'Arrow Circle';?>   </option>
								<option value='4'>  <?php echo '&#xf190' . '&nbsp; &nbsp;&nbsp;' . 'Arrow Circle O';?> </option>
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the size of the arrow icon. "></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the icon color to change Thumbnail's pictures."></i></div>
						<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Divv2">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Icon Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="You can choose icons from different beautifully designed sets in lightbox to close the portfolio."></i></div>
						<div class="TS_Port_Option_Field">
							<select class="Total_Soft_Select" name="" id="TotalSoft_PG_EG_62" style="font-family: 'FontAwesome', Arial;">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose in the gallery for the close box which size is approriate."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose the icon color for closing the Thumbnail images in gallery portfolio."></i></div>
						<div class="TS_Port_Option_Field">
	...
	<div class="Total_Soft_Port_AMSetDiv" id="Total_Soft_Port_AMSetDiv_3">
		<div class="Total_Soft_Port_AMSetDiv_Buttons">
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_3_GO" onclick="TS_Port_TM_But('3', 'GO')">General Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_3_NO" onclick="TS_Port_TM_But('3', 'NO')">Navigation Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_3_TD" onclick="TS_Port_TM_But('3', 'TD')">Title & Description</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_3_HO" onclick="TS_Port_TM_But('3', 'HO')">Hover Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_3_IO" onclick="TS_Port_TM_But('3', 'IO')">Icon Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_3_PO" onclick="TS_Port_TM_But('3', 'PO')">Popup Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_3_CO" onclick="TS_Port_TM_But('3', 'CO')">Carousel Option</div>
		</div>
		<div class="Total_Soft_Port_AMSetDiv_Content">
			<div class="TS_Port_Option_Div" id="Total_Soft_Port_AMSetTable_3_GO">
				<div class="TS_Port_Option_Div1 Total_Soft_Titles">General Options</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Text to Show All <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Enter here the text, in which should be included all Images of Portfolio."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="TotalSoft_PG_FG_01" id="TotalSoft_PG_FG_01" class="Total_Soft_Select" placeholder=" * Required" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Images Border Width <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the pictures border width."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Images Border Color <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the border color."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="TotalSoft_PG_FG_03" id="TotalSoft_PG_FG_03" class="Total_Soft_Port_Color" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Place Between Images <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="In the gallery, set the space between the images."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Different Size Images <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select, the images in gallery should be the different sizes or not, Each picture will be appropriate to the size by portfolio, or all in one size."></i></div>
					<div class="TS_Port_Option_Field">
						<div class="switch">
			...
			<div class="TS_Port_Option_Div" id="Total_Soft_Port_AMSetTable_3_NO">
				<div class="TS_Port_Option_Div1 Total_Soft_Titles">Navigation Options</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Main Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the menu main background color for gallery navigation, which includes the names of all categories portfolio."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Font Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the font size of navigation in the gallery of the portfolio."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Effect Type <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose type of hover effect."></i></div>
					<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div TS_Port_Option_Divv" id="Total_Soft_Port_AMSetTable_3_TD">
				<div class="TS_Port_Option_Divv1">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the color of image title in the gallery."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_FG_15" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Font Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Define the font size for the image title."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Font Family <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose the font family for the image title."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Show Description <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose to show the description in gallery or not."></i></div>
						<div class="TS_Port_Option_Field">
							<div class="switch">
				...
				<div class="TS_Port_Option_Divv2">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Background Color <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose the background color for the text container for portfolio."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="TotalSoft_PG_FG_20" id="TotalSoft_PG_FG_20" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Border Width <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Define the border width for the text container in the gallery."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Border Color <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select preferable color for border."></i></div>
						<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div TS_Port_Option_Divv" id="Total_Soft_Port_AMSetTable_3_HO">
				<div class="TS_Port_Option_Divv1">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose a color for the overlay on the image as you hold the mouse arrow on it."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_FG_25" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Effect Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose type of hover effect."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Effect Time <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select time of hover effect for gallery portfolio."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the color for the lines in image."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_FG_28" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Width <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the width for the lines in image."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Effect Time <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Define time of line effect for gallery portfolio."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Effect Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose type of line effect for gallery portfolio."></i></div>
						<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Divv2">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select a color for the overlay on the image, as you keep the mouse arrow on it. The effects are very beautiful and they are very suitable in the gallery."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Effect Time <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Define time of hover effect for gallery."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Effect Time <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Define time of line effect for gallery."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Effect Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose type of line effect for gallery."></i></div>
						<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div TS_Port_Option_Divv" id="Total_Soft_Port_AMSetTable_3_IO">
				<div class="TS_Port_Option_Divv1">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Alter the size of the icon."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Specify preferable background color of the icons."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_FG_42" class="Total_Soft_Port_Color1" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Border Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the border color for icon in the gallery popup container."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_FG_43" class="Total_Soft_Port_Color1" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Border Width <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the border width for popup icon."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Effect Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="You can select the effect type of different and beautifully designed sets."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Effect Time <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the time to increase the icon effect on the gallery. When you hover the mouse over the image you can see the icons effect."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select a color of the icon."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_FG_40" class="Total_Soft_Port_Color1" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Icon Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the icons for image."></i></div>
						<div class="TS_Port_Option_Field">
							<select class="Total_Soft_Select" name="" id="TotalSoft_PG_FG_34" style="font-family: 'FontAwesome', Arial;">
								<option value="1"> <?php echo '&#xf1c5' . '&nbsp; &nbsp;' . 'File Image O';?> </option>
								<option value="2"> <?php echo '&#xf06e' . '&nbsp; &nbsp;' . 'Eye';?>          </option>
								<option value="3"> <?php echo '&#xf083' . '&nbsp; &nbsp;' . 'Camera Retro';?> </option>
								<option value="4"> <?php echo '&#xf03e' . '&nbsp; &nbsp;' . 'Picture O';?>    </option>
								<option value="5"> <?php echo '&#xf00e' . '&nbsp; &nbsp;' . 'Search Plus';?>  </option>
								<option value="6"> <?php echo '&#xf065' . '&nbsp; &nbsp;' . 'Expand';?>       </option>
								<option value="7"> <?php echo '&#xf184' . '&nbsp; &nbsp;' . 'Gratipay';?>     </option>
								<option value="8"> <?php echo '&#xf002' . '&nbsp; &nbsp;' . 'Search';?>       </option>
							</select>
						</div>
					</div>
				</div>
				<div class="TS_Port_Option_Divv2">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the link color which is in the image."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_FG_23" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Define a background color which is intended for the link button."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_FG_24" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Border Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the link border color which is in the image container."></i></div>
						<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div TS_Port_Option_Divv" id="Total_Soft_Port_AMSetTable_3_PO">
				<div class="TS_Port_Option_Divv1">
					<div class="TS_Port_Option_Div1 Total_Soft_Titles">Popup Option</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Overlay Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose a color for the overlay."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_FG_50" class="Total_Soft_Port_Color1" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Start Time <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the time interval for the opening of the gallery in milliseconds in the lightbox."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Stop Time <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set stop time for change of image."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Time Effect Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the time for effect which should be applied by images to changing albums or by clicking on the images to see the description."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Effect Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the effect which will be applied to the images in the lightbox."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Font Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="This function is for the popup window. You can select font size for title. For each screen or mobile version will be its size for responsiveness."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Font Family <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Specify the font family for the title, used with image in a popup window."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="In gallery it is necessary to choose the color for image titles which is in the popup window."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_FG_73" class="Total_Soft_Port_Color1" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the background color which is designed for lightbox title."></i></div>
						<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Divv2">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Width <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="It allows you to specify the preferred width of the image for lightbox and it is all responsive."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Border Width <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the borders of images."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Border Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the image border color which is in the gallery."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_FG_59" class="Total_Soft_Port_Color1" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Carousel Image Height <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="It allows you to specify the preffered height of the carousel image and it is all responsive in portfolio."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Carousel Image Border Width <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the borders of carousel images."></i></div>
						<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div" id="Total_Soft_Port_AMSetTable_3_CO">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Pause Time <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set time interval for change of photos."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Icon Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose the icon color for slideshow in the carousel images."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="" id="TotalSoft_PG_FG_61" class="Total_Soft_Port_Color1" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Icon Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Change the icon size, regardless of the container. The plugin allows to get most suitable navigation arrows that are most appropriate for your site."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Icon Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the left and right icons for the gallery. In which the image should be placed for slide."></i></div>
					<div class="TS_Port_Option_Field">
						<select class="Total_Soft_Select" name="" id="TotalSoft_PG_FG_63" style="font-family: 'FontAwesome', Arial;">
							<option value='1'>  <?php echo '&#xf100' . '&nbsp; &nbsp; &nbsp;' . 'Angle Double';?>  </option>
							<option value='2'>  <?php echo '&#xf104' . '&nbsp; &nbsp; &nbsp;&nbsp;' . 'Angle';?>   </option>
							<option value='3'>  <?php echo '&#xf0a8' . '&nbsp; &nbsp;&nbsp;' . 'Arrow Circle';?>   </option>
							<option value='4'>  <?php echo '&#xf190' . '&nbsp; &nbsp;&nbsp;' . 'Arrow Circle O';?> </option>
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Close Icon Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose in the gallery for the close box which size is approriate."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Close Icon Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose the icon color for close the images in gallery portfolio."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="" id="TotalSoft_PG_FG_65" class="Total_Soft_Port_Color1" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Close Icon Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="You can choose icons from different beautifully designed sets in portfolio to close the lightbox."></i></div>
					<div class="TS_Port_Option_Field">
						<select class="Total_Soft_Select" name="" id="TotalSoft_PG_FG_66" style="font-family: 'FontAwesome', Arial;">
							<option value='1'> <?php echo '&#xf00d' . '&nbsp; &nbsp;' . 'Times';?>          </option>
							<option value='3'> <?php echo '&#xf057' . '&nbsp; &nbsp;' . 'Times Circle';?>   </option>
							<option value='2'> <?php echo '&#xf05c' . '&nbsp; &nbsp;' . 'Times Circle O';?> </option>
						</select>
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Close Icon Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose the close icon background color."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="" id="TotalSoft_PG_FG_67" class="Total_Soft_Port_Color1" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Carousel Icon Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the icon color to change images."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="" id="TotalSoft_PG_FG_68" class="Total_Soft_Port_Color1" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Carousel Icon Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the size of the arrow icon."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Carousel Icon Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the right and the left icons for lightbox."></i></div>
					<div class="TS_Port_Option_Field">
						<select class="Total_Soft_Select" name="" id="TotalSoft_PG_FG_70" style="font-family: 'FontAwesome', Arial;">
							<option value='1'>  <?php echo '&#xf100' . '&nbsp; &nbsp; &nbsp;' . 'Angle Double';?>  </option>
							<option value='2'>  <?php echo '&#xf104' . '&nbsp; &nbsp; &nbsp;&nbsp;' . 'Angle';?>   </option>
							<option value='3'>  <?php echo '&#xf0a8' . '&nbsp; &nbsp;&nbsp;' . 'Arrow Circle';?>   </option>
							<option value='4'>  <?php echo '&#xf190' . '&nbsp; &nbsp;&nbsp;' . 'Arrow Circle O';?> </option>
	...
	<div class="Total_Soft_Port_AMSetDiv" id="Total_Soft_Port_AMSetDiv_4">
		<div class="Total_Soft_Port_AMSetDiv_Buttons">
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_4_GO" onclick="TS_Port_TM_But('4', 'GO')">General Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_4_HO" onclick="TS_Port_TM_But('4', 'HO')">Hover Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_4_TO" onclick="TS_Port_TM_But('4', 'TO')">Title Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_4_LO" onclick="TS_Port_TM_But('4', 'LO')">Link Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_4_PO" onclick="TS_Port_TM_But('4', 'PO')">Popup Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_4_IO" onclick="TS_Port_TM_But('4', 'IO')">Icon Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_4_NO" onclick="TS_Port_TM_But('4', 'NO')">Navigation Option</div>
		</div>
		<div class="Total_Soft_Port_AMSetDiv_Content">
			<div class="TS_Port_Option_Div" id="Total_Soft_Port_AMSetTable_4_GO">
				<div class="TS_Port_Option_Div1 Total_Soft_Titles">General Options</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Width <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="It allows you to specify the preferred width of the image and it is all responsive in gallery."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Place Between <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the distance between each image."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Box Shadow <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the shadow value for the image."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Shadow Color <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select shadow color which allows to show the shadow color of the image."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="TotalSoft_PG_CP_04" id="TotalSoft_PG_CP_04" class="Total_Soft_Port_Color" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Border Width <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Specify the preferred width of the border for image."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Border Style <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Identify the basic style of the image border and you can change it at any time. Select 4 different types of borders: Solid, Dotted, Dashed, Double."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Border Radius <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the border radius in your gallery image."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Zoom Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="You can select the type of scaling of different and beautifully designed sets from the image."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Zoom Time <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the time to increase the effect on the gallery. When you hover the mouse over the image you can see the zoom effect."></i></div>
					<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div TS_Port_Option_Divv" id="Total_Soft_Port_AMSetTable_4_HO">
				<div class="TS_Port_Option_Divv1">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Line Width <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the line width."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Line Style <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose the style to be applied to the line."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Line Color <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select your preferred color to show the line of separation."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="TotalSoft_PG_CP_22" id="TotalSoft_PG_CP_22" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Effect Type <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="There are 7 different line effect types in gallery."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Effect Time <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select time of hover line effect for gallery."></i></div>
						<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Divv2">
					<div class="TS_Port_Option_Div1 Total_Soft_Titles">Hover Overlay Option</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select a background color for the overlay on the image as you keep the mouse arrow on it. The effects are very beautiful and they are very suitable in the gallery."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_CP_11" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Effect Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the Hover Effect type. There are 13 effects type in lightbox gallery. They are all differenet from each other."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Effect Time <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select time of hover effect for gallery."></i></div>
						<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div" id="Total_Soft_Port_AMSetTable_4_TO">
				<div class="TS_Port_Option_Div1 Total_Soft_Titles">Title Options</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the background color for the text container."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="" id="TotalSoft_PG_CP_14" class="Total_Soft_Port_Color" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Font Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Specify the font size for the image title."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select a color for your title which will be seen in gallery."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="" id="TotalSoft_PG_CP_16" class="Total_Soft_Port_Color" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Hover Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine preferable type of your hover effects."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Hover Time <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select time of hover effect for gallery."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Font Family <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the preferred font family for the title. Gallery has a basic Google font."></i></div>
					<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div" id="Total_Soft_Port_AMSetTable_4_LO">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Font Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the font size for the link button."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the color of the button which you will see in image."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="" id="TotalSoft_PG_CP_26" class="Total_Soft_Port_Color" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Border Color <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the link border color which is in the image container."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="TotalSoft_PG_CP_27" id="TotalSoft_PG_CP_27" class="Total_Soft_Port_Color" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Border Width <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the link border width which is in the image container."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Border Style <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the link border style."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Link Text <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Enter the text that should be in link button. When you have created a gallery in each box has URL."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" class="Total_Soft_Select" name="TotalSoft_PG_CP_30" id="TotalSoft_PG_CP_30" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Hover Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine preferable link type of your hover effects."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Font Family <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the preferred font family for the link button. Gallery has a basic Google font."></i></div>
					<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div TS_Port_Option_Divv" id="Total_Soft_Port_AMSetTable_4_PO">
				<div class="TS_Port_Option_Divv1">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose your preferable background color for popup."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_CP_34" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Border Width <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the width of the border for the container in a popup window."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Border Style <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the style for the border of the popup."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Border Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine border color which is in the popup."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_CP_37" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Border Radius <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="In the popup window it is possible to give a border radius. You can specify the radius of the pixels. In gallery it is all responsive."></i></div>
						<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Divv2">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Show <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose to show the title or not in popup."></i></div>
						<div class="TS_Port_Option_Field">
							<div class="switch">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Text Align <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose text align for title (left, center and right)."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="In the gallery set the color for the image title."></i></div>
						<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div TS_Port_Option_Divv" id="Total_Soft_Port_AMSetTable_4_IO">
				<div class="TS_Port_Option_Divv1">
					<div class="TS_Port_Option_Div1 Total_Soft_Titles">Close Icon Option</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="You can choose icons from different beautifully designed sets in portfolio to close the lightbox."></i></div>
						<div class="TS_Port_Option_Field">
							<select class="Total_Soft_Select" name="" id="TotalSoft_PG_CP_47" style="font-family: 'FontAwesome', Arial;">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose the icon color for close the popup."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_CP_49" class="Total_Soft_Port_Color1" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Text <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Enter the text that should be in close button."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_CP_50" maxlength="10" class="Total_Soft_Select" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Font Family <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select your preferable font family for close button."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Note the size of the numbers. It is fully responsive."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the color of the numbers."></i></div>
						<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Divv2">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="You can select icons from a variety of beautifully designed sets for the lightbox."></i></div>
						<div class="TS_Port_Option_Field">
							<select class="Total_Soft_Select" name="" id="TotalSoft_PG_CP_44" style="font-family: 'FontAwesome', Arial;">
								<option value='play'>          <?php echo '&#xf04b' . '&nbsp; &nbsp;' . 'Play';?>          </option>
								<option value='play-circle'>   <?php echo '&#xf144' . '&nbsp; &nbsp;' . 'Play Circle';?>   </option>
								<option value='play-circle-o'> <?php echo '&#xf01d' . '&nbsp; &nbsp;' . 'Play Circle O';?> </option>
							</select>
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the size of the play icon."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the icon color to change images."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the right and the left icons for popup which are for change the images by sequence."></i></div>
						<div class="TS_Port_Option_Field">
							<select class="Total_Soft_Select" name="" id="TotalSoft_PG_CP_52" style="font-family: 'FontAwesome', Arial;">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Change the icon size regardless of the container. The gallery portfolio plugin allows to get most suitable navigation arrows that are most appropriate for your site."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the icon color to change the image."></i></div>
						<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div" id="Total_Soft_Port_AMSetTable_4_NO">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Current Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the menu current color for gallery navigation which all the categories displayed in the main menu."></i></div>
					<div class="TS_Port_Option_Field">
	...
	<div class="Total_Soft_Port_AMSetDiv" id="Total_Soft_Port_AMSetDiv_5">
		<div class="Total_Soft_Port_AMSetDiv_Buttons">
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_5_GO" onclick="TS_Port_TM_But('5', 'GO')">General Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_5_AO" onclick="TS_Port_TM_But('5', 'AO')">Album Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_5_IO" onclick="TS_Port_TM_But('5', 'IO')">Image Title Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_5_TO" onclick="TS_Port_TM_But('5', 'TO')">Thumbnails Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_5_IC" onclick="TS_Port_TM_But('5', 'IC')">Icon Option</div>
		</div>
		<div class="Total_Soft_Port_AMSetDiv_Content">
			<div class="TS_Port_Option_Div" id="Total_Soft_Port_AMSetTable_5_GO">
				<div class="TS_Port_Option_Div1 Total_Soft_Titles">General Options</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">SlideShow Button <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose to show the slideshow button in gallery or no."></i></div>
					<div class="TS_Port_Option_Field">
						<div class="switch">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">AutoPlay <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="If this parameter is not specified autoplay for slideshow will be disabled."></i></div>
					<div class="TS_Port_Option_Field">
						<div class="switch">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Width <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="It allows you to specify the preferred width of the slider and it is all responsive."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Height <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="It allows you to specify the preferred height of the slider and it is all responsive."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Position <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Make a choice among the 3 positions for the slider: center, right, left."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Border Width <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the border width."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Border Style <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose the frame style for slider."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Border Color <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the border color for slider."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="TotalSoft_PG_SP_08" id="TotalSoft_PG_SP_08" class="Total_Soft_Port_Color" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Tooltips <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose to show the tooltips in slider or no."></i></div>
					<div class="TS_Port_Option_Field">
						<div class="switch">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Transition Effect <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the desired transition effect from the list."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Backward Effect <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the desired backward effect from the list."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Transition Cols <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Specify the number of transition cols which will be shown."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Transition Rows <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Specify the number of transition rows which will be shown."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Transition Duration <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Duration of transition between slides."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Swipe Effect <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose to show the swipe effect in slider or no."></i></div>
					<div class="TS_Port_Option_Field">
						<div class="switch">
			...
			<div class="TS_Port_Option_Div TS_Port_Option_Divv" id="Total_Soft_Port_AMSetTable_5_AO">
				<div class="TS_Port_Option_Divv1">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Font Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the font size for the album title. It is also designed for menu."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Font Family <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the font family for the album title. It is also designed for menu."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the background color for the album title."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_SP_18" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose the color for the title."></i></div>
						<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Divv2">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose your preferable color for select menu."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_SP_20" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose your preferable background color for select menu."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Hover Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title=" Select the menu background color when the portfolio is separated by categories."></i></div>
						<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div" id="Total_Soft_Port_AMSetTable_5_IO">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Show Title <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose to show the title in slider or no for image."></i></div>
					<div class="TS_Port_Option_Field">
						<div class="switch">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the color for the title."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="" id="TotalSoft_PG_SP_26" class="Total_Soft_Port_Color" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the background color for the title."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="" id="TotalSoft_PG_SP_27" class="Total_Soft_Port_Color" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Font Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine your preferred font size for image title."></i></div>
					<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div" id="Total_Soft_Port_AMSetTable_5_TO">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Width in Full Screen <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the width of the full screen view in lightbox."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Height in Full Screen <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the height of the full screen view in lightbox."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Position <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose position for the thumbnail."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select one of this three options for thumbnails view."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the background color for the thumbnails."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="" id="TotalSoft_PG_SP_36" class="Total_Soft_Port_Color" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the color for the thumbnails."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="" id="TotalSoft_PG_SP_37" class="Total_Soft_Port_Color" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Area Background <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose area background color."></i></div>
					<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div TS_Port_Option_Divv" id="Total_Soft_Port_AMSetTable_5_IC">
				<div class="TS_Port_Option_Divv1">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Zoom Show <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose to show the zoom icon in slider or no."></i></div>
						<div class="TS_Port_Option_Field">
							<div class="switch">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Zoom Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the color for the zoom icon."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_SP_41" class="Total_Soft_Port_Color1" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Full Screen Show <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose to show the full screen icon in slider or no."></i></div>
						<div class="TS_Port_Option_Field">
							<div class="switch">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Full Screen Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the color for the full screen icon."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_SP_42" class="Total_Soft_Port_Color1" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Play/Pause Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the color for the play/pause icon."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_SP_43" class="Total_Soft_Port_Color1" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Album Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the color for the album icon."></i></div>
						<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Divv2">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="You can select icons from a variety of beautifully designed sets for the slider."></i></div>
						<div class="TS_Port_Option_Field">
							<select class="Total_Soft_Select" name="" id="TotalSoft_PG_SP_45" style="font-family: 'FontAwesome', Arial;">
								<option value='angle-double'>   <?php echo '&#xf100' . '&nbsp; &nbsp; &nbsp;' . 'Angle Double';?>  </option>
								<option value='angle'>          <?php echo '&#xf104' . '&nbsp; &nbsp; &nbsp;&nbsp;' . 'Angle';?>   </option>
								<option value='arrow-circle'>   <?php echo '&#xf0a8' . '&nbsp; &nbsp;&nbsp;' . 'Arrow Circle';?>   </option>
								<option value='arrow-circle-o'> <?php echo '&#xf190' . '&nbsp; &nbsp;&nbsp;' . 'Arrow Circle O';?> </option>
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the icon color to change pictures slider."></i></div>
						<div class="TS_Port_Option_Field">
	...
	<div class="Total_Soft_Port_AMSetDiv" id="Total_Soft_Port_AMSetDiv_6">
		<div class="Total_Soft_Port_AMSetDiv_Buttons">
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_6_GO" onclick="TS_Port_TM_But('6', 'GO')">General Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_6_AT" onclick="TS_Port_TM_But('6', 'AT')">Album Title</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_6_IO" onclick="TS_Port_TM_But('6', 'IO')">Icon Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_6_PO" onclick="TS_Port_TM_But('6', 'PO')">Popup Option</div>
		</div>
		<div class="Total_Soft_Port_AMSetDiv_Content">
			<div class="TS_Port_Option_Div" id="Total_Soft_Port_AMSetTable_6_GO">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Hover Effect <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose type of hover effect."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Album/Description Position <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the Position for Albums and Descriptions."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Position Reverse <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Mark gallery albums and descriptions positions reverse or not."></i></div>
					<div class="TS_Port_Option_Field">
						<div class="switch">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Hover Overlay Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose a color for the overlay."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="" id="TotalSoft_PG_GA_04" class="Total_Soft_Port_Color" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Width <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="It allows you to specify the preferred width of the image albums and it is all responsive."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Height <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="It allows you to specify the preferred height of the image albums."></i></div>
					<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div" id="Total_Soft_Port_AMSetTable_6_AT">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Border Color <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the album title border color which is in the gallery."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="TotalSoft_PG_GA_07" id="TotalSoft_PG_GA_07" class="Total_Soft_Port_Color" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Border Radius <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the border radius in your gallery image for the album title."></i></div>
					<div class="TS_Port_Option_Field">
						<div class="switch">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the color for the album title text."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="" id="TotalSoft_PG_GA_10" class="Total_Soft_Port_Color" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Font Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the font size for the album title by pixels."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Font Family <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the font family for the album title."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Box Shadow <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose you want the shadow for the album title or no."></i></div>
					<div class="TS_Port_Option_Field">
						<div class="switch">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Shadow Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title=" Select shadow type."></i></div>
					<div class="TS_Port_Option_Field">
						<div class="switch">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Shadow Color <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the box shadow color for album title."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="TotalSoft_PG_GA_15" id="TotalSoft_PG_GA_15" class="Total_Soft_Port_Color" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Background Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Specify the background type: transparent, color or gradient."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Background Color 1 <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose the background color of the album title."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="" id="TotalSoft_PG_GA_17" class="Total_Soft_Port_Color" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Background Color 2 <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose second background color for gradient effect."></i></div>
					<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div TS_Port_Option_Divv" id="Total_Soft_Port_AMSetTable_6_IO">
				<div class="TS_Port_Option_Divv1">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose the icon for opening the popup."></i></div>
						<div class="TS_Port_Option_Field">
							<select class="Total_Soft_Select" name="" id="TotalSoft_PG_GA_19" style="font-family: 'FontAwesome', Arial;">
								<option value="">     None                                                              </option>
								<option value="f030"> <?php echo '&#xf030' . '&nbsp; &nbsp; &nbsp;' . 'Camera';?>       </option>
								<option value="f083"> <?php echo '&#xf083' . '&nbsp; &nbsp; &nbsp;' . 'Camera Retro';?> </option>
								<option value="f06e"> <?php echo '&#xf06e' . '&nbsp; &nbsp; &nbsp;' . 'Eye';?>          </option>
								<option value="f08a"> <?php echo '&#xf08a' . '&nbsp; &nbsp; &nbsp;' . 'Heart O';?>      </option>
								<option value="f03e"> <?php echo '&#xf03e' . '&nbsp; &nbsp; &nbsp;' . 'Picture O';?>    </option>
								<option value="f002"> <?php echo '&#xf002' . '&nbsp; &nbsp; &nbsp;' . 'Search';?>       </option>
							</select>
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose the icon color, which is designed to open the popup."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_GA_20" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select that size, which would be more relevant for portfolio. It is responsive too."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the background color for the icon."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_GA_22" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Border Radius <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose you want border radius for the icon container or no."></i></div>
						<div class="TS_Port_Option_Field">
							<div class="switch">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Hover Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the icon hover background color."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_GA_24" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Hover Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the icon hover color."></i></div>
						<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Divv2">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose the icon for closing the popup."></i></div>
						<div class="TS_Port_Option_Field">
							<select class="Total_Soft_Select" name="" id="TotalSoft_PG_GA_34" style="font-family: 'FontAwesome', Arial;">
								<option value="">     None                                                         </option>
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose the icon color, which is designed to close the popup."></i></div>
						<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div TS_Port_Option_Divv" id="Total_Soft_Port_AMSetTable_6_PO">
				<div class="TS_Port_Option_Divv1">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the right and the left icons for portfolio, which are for changing images by sequence."></i></div>
						<div class="TS_Port_Option_Field">
							<select class="Total_Soft_Select" name="" id="TotalSoft_PG_GA_27" style="font-family: 'FontAwesome', Arial;">
								<option value='angle-double'>   <?php echo '&#xf100' . '&nbsp; &nbsp; &nbsp;' . 'Angle Double';?>  </option>
								<option value='angle'>          <?php echo '&#xf104' . '&nbsp; &nbsp; &nbsp;&nbsp;' . 'Angle';?>   </option>
								<option value='arrow-circle'>   <?php echo '&#xf0a8' . '&nbsp; &nbsp;&nbsp;' . 'Arrow Circle';?>   </option>
								<option value='arrow-circle-o'> <?php echo '&#xf190' . '&nbsp; &nbsp;&nbsp;' . 'Arrow Circle O';?> </option>
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select a color of the left and right icons."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_GA_28" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set a size of the left and right icons."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the background color for the arrows."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_GA_30" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Border Radius <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose you want border radius for the arrows container or no."></i></div>
						<div class="TS_Port_Option_Field">
							<div class="switch">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Hover Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the arrows hover background color."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_GA_32" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Hover Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the arrows hover color."></i></div>
						<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Divv2">
					<div class="TS_Port_Option_Div1 Total_Soft_Titles">Popup Option</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Overlay Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the popup overlay color."></i></div>
						<div class="TS_Port_Option_Field">
	...
	<div class="Total_Soft_Port_AMSetDiv" id="Total_Soft_Port_AMSetDiv_7">
		<div class="Total_Soft_Port_AMSetDiv_Buttons">
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_7_GO" onclick="TS_Port_TM_But('7', 'GO')">General Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_7_NO" onclick="TS_Port_TM_But('7', 'NO')">Navigation Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_7_IT" onclick="TS_Port_TM_But('7', 'IT')">Image & Title</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_7_IO" onclick="TS_Port_TM_But('7', 'IO')">Icon Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_7_PO" onclick="TS_Port_TM_But('7', 'PO')">Popup Option</div>
		</div>
		<div class="Total_Soft_Port_AMSetDiv_Content">
			<div class="TS_Port_Option_Div" id="Total_Soft_Port_AMSetTable_7_GO">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Icons Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the size for the link and popup icons."></i></div>
					<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div" id="Total_Soft_Port_AMSetTable_7_NO">
				<div class="TS_Port_Option_Div1 Total_Soft_Titles">Navigation Options</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Main Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Identify gallery portfolio navigation main menu background color."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="" id="TotalSoft_PG_PH_04" class="Total_Soft_Port_Color" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Determine the background color for the album titles in navigation menu."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="" id="TotalSoft_PG_PH_05" class="Total_Soft_Port_Color" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose the menu font color."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Font Family <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="For the menu text choose the font family."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Hover Effect <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the hover effect type for the navigation menu."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Hover Effect Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the color for the hover effect."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="" id="TotalSoft_PG_PH_10" class="Total_Soft_Port_Color" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Hover Text Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the text color for hovering the menu."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="" id="TotalSoft_PG_PH_11" class="Total_Soft_Port_Color" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Shadow Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select shadow type for the navigation menu."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Shadow Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the shadow color."></i></div>
					<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div TS_Port_Option_Divv" id="Total_Soft_Port_AMSetTable_7_IT">
				<div class="TS_Port_Option_Divv1">
					<div class="TS_Port_Option_Div1 Total_Soft_Titles">Image Option</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Column Count <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select how many images you want to be in one row."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Standard Height <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose you want fixed height for each image or no."></i></div>
						<div class="TS_Port_Option_Field">
							<div class="switch">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Height <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the fixed height for the images in your gallery."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Hover Effect <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select type of hover effect for images."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Hover Color 1 <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the color for hover effects."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_PH_18" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Hover Color 2 <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select second color for hover effects."></i></div>
						<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Divv2">
					<div class="TS_Port_Option_Div1 Total_Soft_Titles">Title Option</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the image title color in gallery."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Font Family <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="For the image title text choose the font family."></i></div>
						<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div TS_Port_Option_Divv" id="Total_Soft_Port_AMSetTable_7_IO">
				<div class="TS_Port_Option_Divv1">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the type of link icon."></i></div>
						<div class="TS_Port_Option_Field">
							<select class="Total_Soft_Select" name="" id="TotalSoft_PG_PH_23" style="font-family: 'FontAwesome', Arial;">
								...
								<option value="paperclip">            <?php echo '&#xf0c6' . '&nbsp; &nbsp;' . 'Paperclip';?>             </option>
							</select>
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the background color for link icon container."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_PH_24" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the color for the link icon."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_PH_25" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Hover Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the hover background color for the link icon."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_PH_26" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Hover Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the hover color for the link icon."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the type of popup icon."></i></div>
						<div class="TS_Port_Option_Field">
							<select class="Total_Soft_Select" name="" id="TotalSoft_PG_PH_28" style="font-family: 'FontAwesome', Arial;">
								<option value="camera-retro"> <?php echo '&#xf083' . '&nbsp; &nbsp; &nbsp;' . 'Camera Retro';?> </option>
								<option value="camera">       <?php echo '&#xf030' . '&nbsp; &nbsp; &nbsp;' . 'Camera';?>       </option>
								<option value="eye">          <?php echo '&#xf06e' . '&nbsp; &nbsp; &nbsp;' . 'Eye';?>          </option>
								<option value="heart-o">      <?php echo '&#xf08a' . '&nbsp; &nbsp; &nbsp;' . 'Heart O';?>      </option>
								<option value="picture-o">    <?php echo '&#xf03e' . '&nbsp; &nbsp; &nbsp;' . 'Picture O';?>    </option>
								<option value="search">       <?php echo '&#xf002' . '&nbsp; &nbsp; &nbsp;' . 'Search';?>       </option>
							</select>
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the background color for the popup icon container."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_PH_29" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the color for the popup icon."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_PH_30" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Hover Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the hover background color for the popup icon."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_PH_31" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Hover Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the hover color for the popup icon."></i></div>
						<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Divv2">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the size for the icon which is for closing the popup."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the background color for the popup close icon."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_PH_47" class="Total_Soft_Port_Color1" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the icon color."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_PH_48" class="Total_Soft_Port_Color1" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Hover Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the hover background color for the popup close icon."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_PH_49" class="Total_Soft_Port_Color1" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Hover Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose close icon hover color in popup."></i></div>
						<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div TS_Port_Option_Divv" id="Total_Soft_Port_AMSetTable_7_PO">
				<div class="TS_Port_Option_Divv1">
					<div class="TS_Port_Option_Div1 Total_Soft_Titles">Popup Option</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Open Popup <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose you want to open popup or no. "></i></div>
						<div class="TS_Port_Option_Field">
							<div class="switch">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Image Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the background color for the image container in popup."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Text Align <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose text align for title in popup (left, center and right)."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Font Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Define the font size for the image title in popup."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Font Family <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose the font family for the image title in popup."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the backgrounf color for the title and description container in popup."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_PH_38" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="In the gallery set the color for the image title in popup."></i></div>
						<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Divv2">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the right and the left icons for portfolio, which are for changing images by sequence."></i></div>
						<div class="TS_Port_Option_Field">
							<select class="Total_Soft_Select" name="" id="TotalSoft_PG_PH_40" style="font-family: 'FontAwesome', Arial;">
								<option value='angle-double'>   <?php echo '&#xf100' . '&nbsp; &nbsp; &nbsp;' . 'Angle Double';?>  </option>
								<option value='angle'>          <?php echo '&#xf104' . '&nbsp; &nbsp; &nbsp;&nbsp;' . 'Angle';?>   </option>
								<option value='arrow-circle'>   <?php echo '&#xf0a8' . '&nbsp; &nbsp;&nbsp;' . 'Arrow Circle';?>   </option>
								<option value='arrow-circle-o'> <?php echo '&#xf190' . '&nbsp; &nbsp;&nbsp;' . 'Arrow Circle O';?> </option>
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the background color for the left and right icons in popup."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_PH_41" class="Total_Soft_Port_Color1" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the color for the left and right icons in popup."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_PH_42" class="Total_Soft_Port_Color1" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Hover Background Color <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose hover background color for the arrows in popup."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="TotalSoft_PG_PH_43" id="TotalSoft_PG_PH_43" class="Total_Soft_Port_Color1" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Hover Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose arrows hover color in popup."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_PH_44" class="Total_Soft_Port_Color1" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the size for the arrows in popup by pixels."></i></div>
						<div class="TS_Port_Option_Field">
	...
	<div class="Total_Soft_Port_AMSetDiv" id="Total_Soft_Port_AMSetDiv_8">
		<div class="Total_Soft_Port_AMSetDiv_Buttons">
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_8_GO" onclick="TS_Port_TM_But('8', 'GO')">General Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_8_NO" onclick="TS_Port_TM_But('8', 'NO')">Navigation Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_8_IT" onclick="TS_Port_TM_But('8', 'IT')">Image & Title</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_8_IO" onclick="TS_Port_TM_But('8', 'IO')">Icon Option</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_8_TD" onclick="TS_Port_TM_But('8', 'TD')">Title & Description</div>
			<div class="Total_Soft_Port_AMSetDiv_Button" id="TS_Port_TM_TBut_8_LO" onclick="TS_Port_TM_But('8', 'LO')">Link Option</div>
		</div>
		<div class="Total_Soft_Port_AMSetDiv_Content">
			<div class="TS_Port_Option_Div" id="Total_Soft_Port_AMSetTable_8_GO">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Place Between <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="In the gallery, set the space between the images."></i></div>
					<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div" id="Total_Soft_Port_AMSetTable_8_NO">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Hover Text Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the text color for hovering the navigation menu."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="" id="TotalSoft_PG_LG_11" class="Total_Soft_Port_Color" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Shadow Type <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the shadow type for navigation menu."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Shadow Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the shadow color for navigation menu."></i></div>
					<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div TS_Port_Option_Divv" id="Total_Soft_Port_AMSetTable_8_IT">
				<div class="TS_Port_Option_Divv1">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Image Ratio <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select image ratio which will be better for your gallery."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Hover Effect <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select hover effect for images."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Hover Color 1 <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the color for hover effect."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_LG_17" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Hover Color 2 <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the second hover color. Some effects have two colors."></i></div>
						<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Divv2">
					<div class="TS_Port_Option_Div1 Total_Soft_Titles">Title Option</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Font Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the font size for image title."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Font Family <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the font for image titles. On some effects titles will be on image by hovering."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the text color for image title."></i></div>
						<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div TS_Port_Option_Divv" id="Total_Soft_Port_AMSetTable_8_IO">
				<div class="TS_Port_Option_Divv1">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Type <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select icon type for opening the popup window."></i></div>
						<div class="TS_Port_Option_Field">
							<select class="Total_Soft_Select" name="TotalSoft_PG_LG_19" id="TotalSoft_PG_LG_19" style="font-family: 'FontAwesome', Arial;">
								<option value="camera-retro"> <?php echo '&#xf083' . '&nbsp; &nbsp; &nbsp;' . 'Camera Retro';?> </option>
								<option value="camera">       <?php echo '&#xf030' . '&nbsp; &nbsp; &nbsp;' . 'Camera';?>       </option>
								<option value="eye">          <?php echo '&#xf06e' . '&nbsp; &nbsp; &nbsp;' . 'Eye';?>          </option>
								<option value="heart-o">      <?php echo '&#xf08a' . '&nbsp; &nbsp; &nbsp;' . 'Heart O';?>      </option>
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select size for icon to open popup window."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Some effects have background color for icon. Set the background color."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_LG_21" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the color for popup icon."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_LG_22" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Hover Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set hover background color for icon."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_LG_23" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Hover Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set icon hover color for popup  window."></i></div>
						<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Divv2">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Type <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the type for icon to close the popup window."></i></div>
						<div class="TS_Port_Option_Field">
							<select class="Total_Soft_Select" name="TotalSoft_PG_LG_29" id="TotalSoft_PG_LG_29" style="font-family: 'FontAwesome', Arial;">
								<option value='times'>          <?php echo '&#xf00d' . '&nbsp; &nbsp;' . 'Times';?>          </option>
								<option value='times-circle'>   <?php echo '&#xf057' . '&nbsp; &nbsp;' . 'Times Circle';?>   </option>
								<option value='times-circle-o'> <?php echo '&#xf05c' . '&nbsp; &nbsp;' . 'Times Circle O';?> </option>
							</select>
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the close icon size."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the color for lightbox close icon."></i></div>
						<div class="TS_Port_Option_Field">
							<input type="text" name="" id="TotalSoft_PG_LG_31" class="Total_Soft_Port_Color" value="">
						</div>
					</div>
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Hover Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the hover color for close icon."></i></div>
						<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div TS_Port_Option_Divv" id="Total_Soft_Port_AMSetTable_8_TD">
				<div class="TS_Port_Option_Divv1">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Font Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select size for the image title in lightbox."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Font Family <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select font family for image title."></i></div>
						<div class="TS_Port_Option_Field">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the color for lightbox image's titles."></i></div>
						<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Divv2">
					...
					<div class="TS_Port_Option_Div1">
						<div class="TS_Port_Option_Name">Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the background color for description area."></i></div>
						<div class="TS_Port_Option_Field">
			...
			<div class="TS_Port_Option_Div" id="Total_Soft_Port_AMSetTable_8_LO">
				<div class="TS_Port_Option_Div1 Total_Soft_Titles">Link Options</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Font Size <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select font size for link in popup."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Font Family <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the font for link in lightbox."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the color for link in popup."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="" id="TotalSoft_PG_LG_35" class="Total_Soft_Port_Color" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Background Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the background color link."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="" id="TotalSoft_PG_LG_36" class="Total_Soft_Port_Color" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Text <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Write link text which will be in lightbox."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="TotalSoft_PG_LG_37" id="TotalSoft_PG_LG_37"  value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Icon Type <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select icon type for link in popup."></i></div>
					<div class="TS_Port_Option_Field">
						<select class="Total_Soft_Select" name="TotalSoft_PG_LG_38" id="TotalSoft_PG_LG_38" style="font-family: 'FontAwesome', Arial;">
							<option value="link">                 <?php echo '&#xf0c1' . '&nbsp; &nbsp;' . 'Link';?>                  </option>
							<option value="external-link">        <?php echo '&#xf08e' . '&nbsp; &nbsp;' . 'External Link';?>         </option>
							<option value="external-link-square"> <?php echo '&#xf14c' . '&nbsp; &nbsp; ' . 'External Link Square';?> </option>
							<option value="paperclip">            <?php echo '&#xf0c6' . '&nbsp; &nbsp;' . 'Paperclip';?>             </option>
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Icon Position <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select icon position for link button."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Button Style <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select link button style."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Hover Effect Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select link button's hover effect color."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="" id="TotalSoft_PG_LG_41" class="Total_Soft_Port_Color1" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Hover Color <span class="TS_Free_version_Span">(Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select link button's hover text color."></i></div>
					<div class="TS_Port_Option_Field">
						<input type="text" name="" id="TotalSoft_PG_LG_42" class="Total_Soft_Port_Color1" value="">
					</div>
				</div>
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Position <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Set the link button position in lightbox."></i></div>
					<div class="TS_Port_Option_Field">
				...
				<div class="TS_Port_Option_Div1">
					<div class="TS_Port_Option_Name">Alignment <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select the alignment for link button in popup."></i></div>
					<div class="TS_Port_Option_Field">
