	...
	class  Total_Soft_Portfolio extends WP_Widget
	{
		...
		function widget($args,$instance)
		{
			...
			<?php if($TotalSoftPortfolioOpt[0]->TotalSoftPortfolio_SetType == 'Total Soft Portfolio'){ ?>
				...
				<div class="portfolio portfolio<?php echo $Total_Soft_Portfolio;?> portfolio_<?php echo $Total_Soft_Portfolio;?>" style="display: none;">
							...
							<?php for($i=0;$i<$TotalSoftPortfolioManager[0]->TotalSoftPortfolio_AlbumCount;$i++){
								...
								<div class="item">
									<?php for($j=0;$j<count($TSoftPort_ElGrid_Images);$j++){ ?>
										<div><img src="<?php echo $TSoftPort_ElGrid_Images[$j]->TotalSoftPortfolio_IURL;?>" class="TS_Img<?php echo $Total_Soft_Portfolio;?>" alt="<?php echo $TSoftPort_ElGrid_Images[$j]->TotalSoftPortfolio_IURL;?>" /></div>
									<?php } ?>
								</div>
							<?php } ?>
						</div>
									...
									plugin = {
										...
										position: {
											...
											check: function(top, left){
												...
												if (top == 0 && size_top == 0 && max_top == 0) { row = 0; }
				...
				<div class="el_grid_port<?php echo $Total_Soft_Portfolio; ?>" style="display: none;">
					<?php for($i=0;$i<$TotalSoftPortfolioManager[0]->TotalSoftPortfolio_AlbumCount;$i++){
						...
						for($j=0;$j<count($TSoftPort_ElGrid_Images);$j++){ ?>
							<img class="el_grid_port_img<?php echo $Total_Soft_Portfolio; ?>" src="<?php echo  $TSoftPort_ElGrid_Images[$j]->TotalSoftPortfolio_IURL; ?>">
					<?php }} ?>
				</div>
										...
										for($j=0;$j<count($TSoftPort_ElGrid_Images);$j++){ ?>
											{
												...
												'tags'          : ['<?php echo str_replace(array(' ','&','@','^','#','$','%','*','!','`','~','(',')','+','=','{','}','[',']',':',';','&quot','&039','|','&lt','&gt',',','.','?','/'),array('','','','','','','','','','','','','','','','','','','','','','','','','','','','','',''), $TSoftPort_ElGrid_Images[$j]->TotalSoftPortfolio_IA);?>']
											},
								<?php }} ?>
							]
						})
